...
const CL = (() => {
  ...
  const LEAD_NAV = [
    ...
    { id:'cl-week',      label:'This Week',    icon:'week',     href:'cl-week.html' },
    { id:'cl-route',     label:'Route Today',  icon:'route',    href:'cl-route.html' },
    { group: 'My City' },
    ...
    { id:'cl-visits',        label:'Visits',        icon:'visit',    href:'cl-visits.html' },
    { id:'cl-follow-ups',    label:'Follow-Ups',    icon:'followup', href:'cl-follow-ups.html', badge:true },
    { id:'cl-handoff',       label:'Handoffs',      icon:'handoff',  href:'cl-handoff.html' },
    { id:'cl-referrals',     label:'Referrals',     icon:'ref',      href:'cl-referrals.html' },
    { group: 'Pipeline' },
    { id:'cl-pipeline',   label:'Pipeline Board',   icon:'pipeline', href:'cl-pipeline.html' },
    { id:'cl-earnings',   label:'My Earnings',      icon:'earnings', href:'cl-earnings.html' },
    { id:'cl-calculator', label:'Commission Calc',  icon:'calc',     href:'cl-calculator.html' },
    { group: 'Relationships' },
    { id:'cl-heat-map',    label:'Heat Map',    icon:'heat',     href:'cl-heat-map.html' },
    { id:'cl-birthdays',   label:'Birthdays',   icon:'birthday', href:'cl-birthdays.html' },
    { id:'cl-conversation',label:'Conversations',icon:'conv',    href:'cl-conversation.html' },
    { group: 'Plan' },
    { id:'cl-target-builder', label:'Target Builder', icon:'target',   href:'cl-target-builder.html' },
    { id:'cl-city-research',  label:'City Research',  icon:'research', href:'cl-city-research.html' },
    { group: 'Learn' },
    { id:'cl-playbook',    label:'Playbook',       icon:'playbook',   href:'cl-playbook.html' },
    { id:'cl-wins',        label:'Win Stories',    icon:'wins',       href:'cl-wins.html' },
    { id:'cl-scripts',     label:'Scripts',        icon:'scripts',    href:'cl-scripts.html' },
    { id:'cl-objections',  label:'Objections',     icon:'objection',  href:'cl-objections.html' },
    { group: 'Content' },
    { id:'cl-content-upload', label:'Upload Content', icon:'upload', href:'cl-content-upload.html' },
    { id:'cl-my-posts',        label:'My Posts',       icon:'posts',  href:'cl-my-posts.html' },
    { group: 'Community' },
    { id:'cl-chat',         label:'City Lead Chat', icon:'chat',  href:'cl-chat.html' },
    { id:'cl-office-hours', label:'Office Hours',   icon:'hours', href:'cl-office-hours.html' },
    ...
    { id:'cl-bug',      label:'Report Bug',   icon:'bug',     href:'cl-bug.html' },
    { id:'cl-suggest',  label:'Suggest Feature',icon:'suggest', href:'cl-suggest.html' },
    { id:'cl-tax-docs', label:'Tax Docs',     icon:'tax',     href:'cl-tax-docs.html' },
  ];
