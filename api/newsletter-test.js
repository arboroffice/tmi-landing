...
// One-off test send of an on-brand Founders of the Future Letters letter.
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const from = req.query.from === 'domain'
      ? 'Founders of the Future Letters <support@tmitechai.com>'
      : 'Founders of the Future Letters <onboarding@resend.dev>';
