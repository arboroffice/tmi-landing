...
function renderIssue(issue = {}, unsubUrl = SITE + '/api/nl-unsubscribe') {
  ...
  const cta = (fmt === 'announcement' || fmt === 'standard')
    ? `<div style="${center ? 'text-align:center;' : ''}margin:36px 0 4px;"><a class="fc-chart" href="${SITE}/complete-audit" style="display:inline-block;background:${CHART};color:#0a0b14;font-family:${FONT};font-weight:700;font-size:14px;letter-spacing:0.01em;padding:15px 34px;border-radius:999px;text-decoration:none;">Get your Intelligent Company Audit &rarr;</a></div>`
    : '';
