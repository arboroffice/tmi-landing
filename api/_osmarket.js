...
const CATALOG = [
  ...
  // ---- Workflows ----------------------------------------------------------
  {
    ...
    spec: {
      ...
      trigger: 'A new lead arrives by form, call, or text',
      steps: [
        'Capture name, contact, and what they need',
        'Send the lead a quick confirmation that you got it',
        'Create the lead record and assign an owner',
        'Notify the sales owner with the details',
        'Set a follow-up reminder for the same day',
      ],
    },
  },
  {
    ...
    spec: {
      ...
      steps: [
        'Send a friendly reminder at 15 days past due',
        'Send a firmer reminder at 30 days past due',
        'Attach the invoice and a payment link each time',
        'Escalate anything past 45 days to the owner',
        'Mark paid and stop reminders when payment lands',
      ],
    },
  },
  {
    ...
    spec: {
      ...
      steps: [
        'Send a text within one minute of the missed call',
        'Ask what they need and offer a callback time',
        'Log the missed call and the reply',
  ...
  },
  {
    ...
    spec: {
      ...
      steps: [
        'Wait two hours after completion',
        'Send one short review request to the customer',
        'Route a low rating to the owner before it posts',
        'Thank the customer when a review goes live',
      ],
    },
  },
  {
    ...
    spec: {
      ...
      steps: [
        'Pull the numbers that matter from the past week',
        'Compare them against goals and the prior week',
        'Call out what moved and what needs a decision',
        'Deliver a one-page summary to the owner',
      ],
    },
  },
