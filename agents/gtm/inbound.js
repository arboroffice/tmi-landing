...
async function writeInboundFollowup({ lead, scoring, routeTag }) {
  const routeContext = {
    audit: 'Move them to the Complete Audit at /complete-audit - a detailed operational audit plus a 30-minute strategy call with the founder and a strategist, where they map the three paths (DIY, done with you, done for you). It is the one entry point for everyone.',
  };
